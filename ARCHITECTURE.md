...
| `_registry.py` + `_catalog/catalog.json` | Name → endpoint/auth/operations resolution, custom-URL validation | Accept credential-routing data from outside the bundled catalog |
