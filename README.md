...
citations, and structured JSON output all work and are live-verified against
every supported provider. Non-text modalities are not implemented yet. The
API is settled but may still shift before 1.0.
