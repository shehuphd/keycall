...
CASES = [
    ...
    # gpt-live-1 is OpenAI's full-duplex v1/live/sessions voice model,
    # served by live(); it must not fall through to the text picker on "gpt".
    ("gpt-live-1", ModelCategory.LIVE),
